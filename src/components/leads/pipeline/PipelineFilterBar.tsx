 ...
 * active), remindere scadente, prioritate, interval de date + reset.
 * Controlat integral din pagina părinte (values + setteri), fără state
 * propriu. Filtrele de status/remindere sunt cele populate automat când se
 * vine de pe cardurile din Dashboard (ex. /leads?status=won).
